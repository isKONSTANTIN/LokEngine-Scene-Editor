...
public class SceneObjectHighlightFramePart extends FramePart {

    public Vector2f position;
    public float size;
    public float rotation;

    public SceneObjectHighlightFramePart(Vector2f position, float size, float rotation) {
    ...
    public SceneObjectHighlightFramePart(Vector2f position, float size) {
        this(position, size, 0);
    }

    public SceneObjectHighlightFramePart(Vector2f position) {
        this(position, 0.2f);
    }
